...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
 ...
 「 ا قناتى على اليوتيوب」◣
		    「https://www.youtube.com/channel/UCiYEeudxm1l6FatfOsA3O4w」◣
		    「 اتمنى ان تعملو اشتراك للقناة وتنشروها  💖🤗」◣                 
 「 رابط فرع الاستقبال」◣
		    「https://chat.whatsapp.com/DNke2sk4ELT4PnqjOogce3」◣
		    「 الي محتاج شروحات يكلم المالك 」◣`,
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "قائمة استمارات مملكة تينسا",
										"description": ".17.",
										"rowId": `${prefix}anon`
									}
								]
...
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `مملكة تينسا كانت تضم حوالي 50 نقابة كانت من افضل الممالك قديما بقيادة الامبراطور ايتشيغو والنائب بياكويا من نأحية التحديات والمسابقات كانت المملكة من الاوائل وقتها لكن في مرة من الايام تعطل هاتف الامبراطور ايشتيغو واختفى حوالي سنتين وعندما عاد  اختفت المملكة وكل شيء  والان هو يحاول ان يحيئ مملكته من البداية التي لاتضم اي نقابة حاليا وخطوته الاولى كانت بأن يعمل بوت وهو انا كيف تشوفوني ؟ ههه مو مشكلة المهم ايشتيغو  يقول اذا بدكم تنضمون معنا اضغطو ع زر رابط الاستقبال.`,unicorn, [{"urlButton": {"displayText": "「 قناتي 」「📍」◣","url": `${myweb}`}},{"urlButton": {"displayText": "「 رابط الاستقبال 」「📌」◣","url": `${sc}`}},{"quickReplyButton": {"displayText": "「 الاستلام 」「🍜」◣","id": 'donate'}},{"quickReplyButton": {"displayText": "「 المالك 」「👤」◣","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
