...
⭐✑ انـرت الجـروب بـدخـولـك👋 @${num.split("@")[0]},
⭐✑ اهـلا بـك معـنا فى  ${metadata.subject}

⭐✑ وصــف الجـروب: ${metadata.desc}
...
⭐✑ لقد رحل العزيز عنا , لا ادرى ما الذى احزنه ولكننا نتوق لروأيته مجددا , تيحاتى . 😌✨` })
                }
            }
        } catch (err) {
            console.log(err)
